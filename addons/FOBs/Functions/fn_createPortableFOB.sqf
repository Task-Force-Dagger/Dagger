...
[
    ...
    "true", {hint "Deploying FOB!";}, {}, {hint "FOB deployed!"; [(_this select 0), (_this select 1)] call TFD_fnc_deployFOB;}, {hint "Couldn't deploy FOB!";},
    [],
    5,
    false,
    "Deploying FOB...",
...
[
    ...
    format ["Check Position (%1)", _name], {[(_this select 0)] call TFD_fnc_checkFOBPos;},
    [],
...
[
    ...
    "true", {hint "Packing up FOB!";}, {}, {hint "FOB packed up!"; [(_this select 0), (_this select 1)] call TFD_fnc_packUpFOB;}, {hint "Couldn't pack up FOB!";},
    [],
    5,
    false,
    "Packing up FOB...",
