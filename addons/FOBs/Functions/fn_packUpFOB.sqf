...
if (!isServer) exitWith {
    _this remoteExec ["TFD_fnc_packUpFOB", 2];
};
...
_respawnPos = _object getVariable "TFD_PortableFOB_RespawnPos";
...
} forEach (_object getVariable ["TFD_PortableFOB_hiddenObjects", []]);