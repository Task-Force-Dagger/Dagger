class TFD_ModulePortableFOB_Camp: Module_F {
    ...
    function = "TFD_fnc_modulePortableFOB_Camp";
    functionPriority = 2;
    isGlobal = 0;
...
class TFD_ModulePortableFOB_Small: Module_F {
    ...
    icon = "\z\tfd\addons\media\images\logo_sm_ca.paa";
    category = QUOTE(PREFIX);
    function = "TFD_fnc_modulePortableFOB_Small";
    functionPriority = 2;
    isGlobal = 0;
    isTriggerActivated = 0;
    isDisposable = 0;
...
class TFD_ModulePortableFOB_Medium: Module_F {
    ...
    icon = "\z\tfd\addons\media\images\logo_sm_ca.paa";
    category = QUOTE(PREFIX);
    function = "TFD_fnc_modulePortableFOB_Medium";
    functionPriority = 2;
    isGlobal = 0;
    isTriggerActivated = 0;
    isDisposable = 0;
...
class TFD_ModulePortableFOB_Large: Module_F {
    ...
    icon = "\z\tfd\addons\media\images\logo_sm_ca.paa";
    category = QUOTE(PREFIX);
    function = "TFD_fnc_modulePortableFOB_Large";
    functionPriority = 2;
    isGlobal = 0;
    isTriggerActivated = 0;
    isDisposable = 0;
