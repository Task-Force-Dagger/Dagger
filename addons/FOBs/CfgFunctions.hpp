class TFD_FOBs {
    ...
    class FOBs {
        ...
        file = "z\tfd\addons\FOBs\Functions";
    ...
    class Compositions_Camp {
        file = "z\tfd\addons\FOBs\Functions\Compositions\Camps";
    ...
    class Compositions_Small {
        file = "z\tfd\addons\FOBs\Functions\Compositions\Small";
    ...
    class Compositions_Medium {
        file = "z\tfd\addons\FOBs\Functions\Compositions\Medium";
    ...
    class Compositions_Large {
        file = "z\tfd\addons\FOBs\Functions\Compositions\Large";
