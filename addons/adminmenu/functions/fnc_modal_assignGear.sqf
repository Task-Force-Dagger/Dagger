...
_ctrlCheckFaction ctrlSetPosition [0, 0, TFD_ADMINMENU_STD_WIDTH, TFD_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelFaction ctrlSetPosition [TFD_ADMINMENU_STD_WIDTH, 0, (0.25 * _ctrlGrpWidth), TFD_ADMINMENU_STD_HEIGHT];
...
_ctrlCheckFromMission ctrlSetPosition [(2 * TFD_ADMINMENU_STD_WIDTH) + (0.25 * _ctrlGrpWidth), 0, TFD_ADMINMENU_STD_WIDTH, TFD_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelFromMission ctrlSetPosition [(3 * TFD_ADMINMENU_STD_WIDTH) + (0.25 * _ctrlGrpWidth), 0, (0.6 * _ctrlGrpWidth), TFD_ADMINMENU_STD_HEIGHT];
...
_ctrlComboFaction ctrlSetPosition [(0.1 * TFD_ADMINMENU_STD_WIDTH), (1.1 * TFD_ADMINMENU_STD_HEIGHT), _ctrlGrpWidth - (0.2 * TFD_ADMINMENU_STD_WIDTH), TFD_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelBracketNumbers ctrlSetPosition [0, (2.2 * TFD_ADMINMENU_STD_HEIGHT), _ctrlGrpWidth, TFD_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelRoles ctrlSetPosition [0, (4.2 * TFD_ADMINMENU_STD_HEIGHT), (0.25 * _ctrlGrpWidth), TFD_ADMINMENU_STD_HEIGHT];
_ctrlLabelRoles ctrlCommit 0;
_ctrlLabelRoles ctrlSetText "Change Roles";

private _ctrlGrpRolesWidth = _ctrlGrpWidth - (0.2 * TFD_ADMINMENU_STD_WIDTH);
private _ctrlGrpRoles = _display ctrlCreate ["RscControlsGroup", -1, _ctrlGroup];
GVAR(utilityTabControls) pushBack _ctrlGrpRoles;
_ctrlGrpRoles ctrlSetPosition [(0.1 * TFD_ADMINMENU_STD_WIDTH), (5.3 * TFD_ADMINMENU_STD_HEIGHT), _ctrlGrpRolesWidth, _ctrlGrpHeight - (6.4 * TFD_ADMINMENU_STD_HEIGHT)];
...
private _ctrlCheckChangeX = _ctrlGrpRolesWidth - TFD_ADMINMENU_STD_WIDTH; {
    ...
    _ctrlLabelPlayer ctrlSetPosition [0, _ctrlLineY, _ctrlLabelPlayerW, TFD_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlComboRole ctrlSetPosition [_ctrlComboRoleX, _ctrlLineY, _ctrlComboRoleW, TFD_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlCheckChange ctrlSetPosition [_ctrlCheckChangeX, _ctrlLineY, TFD_ADMINMENU_STD_WIDTH, TFD_ADMINMENU_STD_HEIGHT];
...
_ctrlButton ctrlSetPosition [_ctrlGrpWidth * 0.8, _ctrlGrpHeight - TFD_ADMINMENU_STD_HEIGHT, _ctrlGrpWidth * 0.2, TFD_ADMINMENU_STD_HEIGHT];
...
_ctrlButton ctrlAddEventHandler ["ButtonClick", {
    ...
    private _selectedFaction = _ctrlComboFaction lbData (lbCurSel _ctrlComboFaction);
 {
    ...
    systemChat format ["[TFD Admin Menu] Assigned gear to %1 players", count GVAR(utility_assigngear_rolectrls)];
}];
