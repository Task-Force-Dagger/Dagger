...
_ctrlLabelTraits ctrlSetPosition [0, 0, (0.25 * _ctrlGrpWidth), TFD_ADMINMENU_STD_HEIGHT];
...
private _traitComboCtrls = [];
 {
    ...
    _ctrlComboTraitLabel ctrlSetPosition [0.1 * TFD_ADMINMENU_STD_WIDTH, _ctrlLineY, _ctrlComboTraitLabelW, TFD_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlComboTrait ctrlSetPosition [_ctrlComboTraitX, _ctrlLineY, _ctrlComboTraitW, TFD_ADMINMENU_STD_HEIGHT];
...
_ctrlButton ctrlAddEventHandler ["ButtonClick", {
    ...
    private _valueUAV = _comboUAV lbValue lbCurSel _comboUAV;
 {
    ...
    systemChat format ["[TFD Admin Menu] Assigned traits to %1 player(s)", count GVAR(utilityData)];
