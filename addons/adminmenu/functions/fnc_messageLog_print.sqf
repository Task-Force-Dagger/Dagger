...
/* ----------------------------------------------------------------------------
Internal Function: TFD_adminmenu_fnc_messageLog_print
...
Examples:
    (begin example)
        [_ctrl] call TFD_adminmenu_fnc_messageLog_print;
    (end)
...
private _lbCtrl = _display displayCtrl IDC_TFD_ADMINMENU_MSGS_LIST;
...
private _return = format [
    "[TFD Adminmenu] Printed entry: %1%2",
