...
_ctrlLabelRadios ctrlSetPosition [0, 0, (0.5 * _ctrlGrpWidth), TFD_ADMINMENU_STD_HEIGHT];
...
_ctrlLabelRadioGroup ctrlSetPosition [0, (1.1 * TFD_ADMINMENU_STD_HEIGHT), 0.5 * _ctrlGrpWidth, TFD_ADMINMENU_STD_HEIGHT];
...
private _radioCtrlsY = 2.2 * TFD_ADMINMENU_STD_HEIGHT;
 {
    ...
    _ctrlRadioCheck ctrlSetPosition [0, _radioCtrlsY + (_forEachIndex * TFD_ADMINMENU_STD_HEIGHT), TFD_ADMINMENU_STD_WIDTH, TFD_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlRadioName ctrlSetPosition [TFD_ADMINMENU_STD_WIDTH, _radioCtrlsY + (_forEachIndex * TFD_ADMINMENU_STD_HEIGHT), (0.5 * _ctrlGrpWidth) - TFD_ADMINMENU_STD_WIDTH, TFD_ADMINMENU_STD_HEIGHT];
...
if (!isNil QEGVAR(acre2,networksWithRadioChannels)) then {
    ...
    _ctrlCheckNetwork ctrlSetPosition [0.5 * _ctrlGrpWidth, 0, TFD_ADMINMENU_STD_WIDTH, TFD_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlLabelNetwork ctrlSetPosition [(0.5 * _ctrlGrpWidth) + TFD_ADMINMENU_STD_WIDTH, 0, (0.5 * _ctrlGrpWidth) - (1.1 * TFD_ADMINMENU_STD_WIDTH), TFD_ADMINMENU_STD_HEIGHT];
    ...
    _ctrlLabelNetworkWarning ctrlSetPosition [0.5 * _ctrlGrpWidth, (1.1 * TFD_ADMINMENU_STD_HEIGHT), 0.5 * _ctrlGrpWidth, TFD_ADMINMENU_STD_HEIGHT];
...
_ctrlButton ctrlAddEventHandler ["ButtonClick", {
    ...
    if !(_networkCtrls isEqualTo []) then {
        ...
        if (cbChecked _ctrlNetworkCheck) then {
            ...
            if (_idx < 0) exitWith {
                systemChat "[TFD Admin Menu] No network selected";
            };
