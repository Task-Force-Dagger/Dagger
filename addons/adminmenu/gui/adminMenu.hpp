...
class GVAR(RscButtonMenu): RscButtonMenu {
    ...
    sizeEx = TFD_ADMINMENU_STD_SIZEX_L;
...
class GVAR(RscSpectatorControlTableText): RscText {
    sizeEx = TFD_ADMINMENU_STD_SIZEX;
    h = "1 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
    w = (6/10) * TFD_ADMINMENU_RESP_W_COL1;
    x = 0;
    y = 0;
};
...
class ADDON {
    ...
    class Controls {
        ...
        class TabDashboard: RscButtonMenu {
            ...
            text = "Dashboard";
            tooltip = "";
            onButtonClick = QUOTE([ARR_2(ctrlParent param [0],IDC_TFD_ADMINMENU_G_DASH)] call FUNC(selectTab));
            colorBackground[] = {0, 0, 0, 0};
            x = "1 * (((safezoneW / safezoneH) min 1.2) / 40) + (safezoneX + (safezoneW - ((safezoneW / safezoneH) min 1.2))/2)";
        ...
        class TabPlayerManagement: TabDashboard {
            ...
            onButtonClick = QUOTE([ARR_2(ctrlParent param [0],IDC_TFD_ADMINMENU_G_PMAN)] call FUNC(selectTab));
        ...
        class TabRespawnPlayers: TabDashboard {
            ...
            onButtonClick = QUOTE([ARR_2(ctrlParent param [0],IDC_TFD_ADMINMENU_G_RESP)] call FUNC(selectTab));
            x = "16 * (((safezoneW / safezoneH) min 1.2) / 40) + (safezoneX + (safezoneW - ((safezoneW / safezoneH) min 1.2))/2)";
        ...
        class TabEndMission: TabDashboard {
            ...
            onButtonClick = QUOTE([ARR_2(ctrlParent param [0],IDC_TFD_ADMINMENU_G_ENDM)] call FUNC(selectTab));
        ...
        class TabMessageLog: TabDashboard {
            ...
            onButtonClick = QUOTE([ARR_2(ctrlParent param [0],IDC_TFD_ADMINMENU_G_MSGS)] call FUNC(selectTab));
...
class GVAR(respawnMapDialog) {
    idd = IDC_TFD_ADMINMENU_RESP_MAP_DISPLAY;
    movingEnable = 0;
    class controlsBackground {
    };
    class objects {
    ...
    class controls {
        class FullRespawnMap: RscMapControl {
            ...
            onSetFocus = QUOTE(_this spawn FUNC(respawn_mapLoaded)); //"['respawnMapLoaded'] spawn tfd_respawn_fnc_handleRespawnUI";
            onMouseButtonDown = QUOTE(_this spawn FUNC(respawn_mapClick)); //"['respawnMap_onMouseButtonDown',_this] spawn tfd_respawn_fnc_handleRespawnUI";
            onKeyUp = QUOTE(_this spawn FUNC(respawn_mapKeyUp)); //"['respawnMap_keyUp',_this] spawn tfd_respawn_fnc_handleRespawnUI";
        };
    };
};
...
class GVAR(adminEyeDialog) {
    idd = IDC_TFD_ADMINMENU_ADME_MAP_DISPLAY;
    movingEnable = 0;
    class controlsBackground {
    };
    class objects {
