class RscNotepad
{
    ...
    scriptPath = "TFDDisplays";
    onLoad = "[""onLoad"",_this,""RscNotepad"",'TFDDisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onUnload = "[""onUnload"",_this,""RscNotepad"",'TFDDisplays'] call  (uinamespace getvariable 'BIS_fnc_initDisplay')";
    onMouseButtonDown = "\
