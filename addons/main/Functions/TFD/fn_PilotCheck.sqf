...
switch (TFD_Main_MaydayAccess) do {
    case 0: { _fnc_checkAccess = {false}; };
    case 1: { _fnc_checkAccess = {(_this getVariable ["TFD_Section", -1]) isEqualTo "909 EAW"}; };
        ...
        if (_vehicle isKindOf "Helicopter") then {
            ...
            if (_unit call _fnc_checkAccess) then {
                ...
                private _handle = [ {
                        ...
                        if ([_vehicle] call TFD_fnc_isPilotDown) exitWith {
                            ...
                            if ((round (speed _vehicle) != 0) || (not isTouchingGround _vehicle)) then {
                                ...
                                if (_unit in ([_vehicle] call TFD_fnc_getCopilots)) then {
                ...
                _vehicle setVariable ["TFD_MaydayHandle", _handle, false];
            };
        };
...
player addEventHandler ["GetOutMan", {
    ...
    _handle = _vehicle getVariable ["TFD_MaydayHandle", -1];
