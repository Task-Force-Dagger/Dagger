[] spawn {
    ...
    TFD_Main_ViewDistanceNoGrass = if (isNil "TFD_Main_ViewDistanceNoGrass") then {true} else {TFD_Main_ViewDistanceNoGrass};
    TFD_Main_ViewDistanceMaxDistance = if (isNil "TFD_Main_ViewDistanceMaxDistance") then {12000} else {TFD_Main_ViewDistanceMaxDistance};
    TFD_Main_ViewDistanceMaxObjectDistance = if (isNil "TFD_Main_ViewDistanceMaxObjectDistance") then {12000} else {TFD_Main_ViewDistanceMaxObjectDistance};
    ...
    CHVD_foot = (profileNamespace getVariable ["CHVD_foot",viewDistance]) min TFD_Main_ViewDistanceMaxDistance;
    CHVD_car = (profileNamespace getVariable ["CHVD_car",viewDistance]) min TFD_Main_ViewDistanceMaxDistance;
    CHVD_air = (profileNamespace getVariable ["CHVD_air",viewDistance]) min TFD_Main_ViewDistanceMaxDistance;

    CHVD_footObj = (profileNamespace getVariable ["CHVD_footObj",viewDistance]) min TFD_Main_ViewDistanceMaxObjectDistance min TFD_Main_ViewDistanceMaxDistance;
    CHVD_footObj = if (CHVD_footSyncMode isEqualTo 1) then {CHVD_foot * CHVD_footSyncPercentage} else {CHVD_footObj}; 
    CHVD_carObj = (profileNamespace getVariable ["CHVD_carObj",viewDistance]) min TFD_Main_ViewDistanceMaxObjectDistance min TFD_Main_ViewDistanceMaxDistance;
    CHVD_carObj = if (CHVD_carSyncMode isEqualTo 1) then {CHVD_car * CHVD_carSyncPercentage} else {CHVD_carObj}; 
    CHVD_airObj = (profileNamespace getVariable ["CHVD_airObj",viewDistance]) min TFD_Main_ViewDistanceMaxObjectDistance min TFD_Main_ViewDistanceMaxDistance;
    CHVD_airObj = if (CHVD_airSyncMode isEqualTo 1) then {CHVD_air * CHVD_airSyncPercentage} else {CHVD_airObj};

    CHVD_footTerrain = if (TFD_Main_ViewDistanceNoGrass) then {profileNamespace getVariable ["CHVD_footTerrain",25]} else {(profileNamespace getVariable ["CHVD_footTerrain",25]) min 48.99 max 3.125};
    CHVD_carTerrain = if (TFD_Main_ViewDistanceNoGrass) then {profileNamespace getVariable ["CHVD_carTerrain",25]} else {(profileNamespace getVariable ["CHVD_carTerrain",25]) min 48.99 max 3.125};
    CHVD_airTerrain = if (TFD_Main_ViewDistanceNoGrass) then {profileNamespace getVariable ["CHVD_airTerrain",25]} else {(profileNamespace getVariable ["CHVD_airTerrain",25]) min 48.99 max 3.125};
