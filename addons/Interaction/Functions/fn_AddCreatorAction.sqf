/*
Function: TFD_fnc_AddCreatorAction
...
if (!TFD_CreatorActions_Master) exitWith {};
...
[
    "TFD_RegisterCreatorAction", [_action, _actionPath, _actionName], format["TFD_CAJIP_%1", _actionName]
