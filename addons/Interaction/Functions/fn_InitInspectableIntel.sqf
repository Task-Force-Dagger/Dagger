/*
Function: TFD_fnc_initInspectableIntel
...
Examples:
    ...
    ] call TFD_fnc_initInspectableIntel;
    (end)
...
//    testing, sharing with side and one specific TFD group works though)
...
// Add the action
[_object, _actionTitle, _diaryRecord select 0] remoteExec ["TFD_fnc_SetIntelAction",0,true];
