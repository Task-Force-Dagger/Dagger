 ...
 * If you want to add weapon(s) without any attachments you may want to use 'TFD_boc_fnc_addItemToChestpack' instead.
 *
 * Arguments:
 * 0: Unit <OBJECT>
 ...
 *
 * Example:
 * [player,["arifle_MX_GL_F","","acc_pointer_IR","optic_Aco",["30Rnd_65x39_caseless_mag",30],["1Rnd_SmokeOrange_Grenade_shell",1],""],2] call TFD_boc_fnc_addWeaponToChestpack;
 *
 * Public: No
 */
