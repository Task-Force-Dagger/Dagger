 ...
 * If you want to add a/multiple full magazine(s) you may want to use 'TFD_boc_fnc_addItemToChestpack' instead.
 *
 * Arguments:
 * 0: Unit <OBJECT>
 * 1: Classname <STRING>
 ...
 *
 * Example:
 * [player,"30Rnd_556x45_Stanag",25,2] call TFD_boc_fnc_addMagToChestpack;
 *
 * Public: No
 */
