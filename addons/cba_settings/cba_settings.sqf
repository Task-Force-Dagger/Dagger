...
CBRN_factionMask_tfd = "G_CBRN_M50";
...
force tfd_adminmenu_printToChat = 1;

// TFD - AI
force tfd_AI_AimingAccuracy = 0.1;
force tfd_AI_AimingShake = 0.45;
force tfd_AI_AimingSpeed = 0.3;
force tfd_AI_Commanding = 1;
force tfd_AI_Courage = 1;
force tfd_AI_General = 1;
force tfd_AI_InitialAI = true;
force tfd_AI_ReloadSpeed = 0.5;
force tfd_AI_Reporting = false;
force tfd_AI_SpotDistance = 0.4;
force tfd_AI_SpotTime = 0.2;

// TFD - ai_disembark
force tfd_ai_disembark_enabled = true;
force tfd_ai_disembark_stayInImmobileChance = 0.2927;

// TFD - back_to_game
tfd_back_to_game_enableAddon = true;
force tfd_back_to_game_removeBody = true;
force tfd_back_to_game_teleportToLeader = true;
force tfd_back_to_game_teleportToVehicle = true;

// TFD - Bodybag
force tfd_bodybag_destroyChance = 20;
...
// TFD - Chat
force tfd_chat_healUsage = 3;
force tfd_chat_radioUsage = 3;
force tfd_chat_rpUsage = 3;
force tfd_chat_specUsage = 3;
force tfd_chat_tpUsage = 3;
force tfd_chat_whisperUsage = 3;

// TFD - fatigue
tfd_fatigue_highJogCoef = 0;
tfd_fatigue_highJogCoefEnabled = false;

// TFD - friendly_fire
force tfd_friendly_fire_loggingEnabled = true;

// TFD - fries
force tfd_fries_autoAdd = true;

// TFD - grass
force tfd_grass_enabled = true;

// TFD - insurgents
force tfd_insurgents_enabled_CUP = false;
force tfd_insurgents_enabled_Vanilla = true;

// TFD - Interaction
TFD_CreatorActions_Channels = true;
TFD_CreatorActions_EndMission = true;
TFD_CreatorActions_Master = true;

// TFD - Interactions
tfd_interactions_backpack_access_enemy = 0;
tfd_interactions_backpack_access_faction = 2;
tfd_interactions_backpack_access_friendly = 1;
tfd_interactions_backpack_access_hint = true;
tfd_interactions_gear_access_enabled = 1;
tfd_interactions_gear_access_hint = true;
tfd_interactions_global_sounds = true;
tfd_interactions_tapshoulder_ai = false;
tfd_interactions_tapshoulder_hint = true;

// TFD - Main
force TFD_Main_ArsenalSaveLoad = true;
force TFD_Main_CueCards = true;
force TFD_Main_Diary = true;
force TFD_Main_DynamicGroups = true;
force TFD_Main_DynamicSim = false;
force TFD_Main_Earplugs = false;
force TFD_Main_FatigueVanilla = true;
force TFD_Main_FlipVehicle = true;
force TFD_Main_LockCamVehicle = false;
...
force TFD_Main_ViewDistanceNoGrass = false;

// TFD - medical
force TFD_medical_persistantRevive = true;
force TFD_medical_persistantReviveTimer = 720;
...
force tfd_respawn_time = 10;

// TFD - safestart
tfd_safestart_startLocked = true;

// TFD - Spectator
force tfd_spectator_allowAI = false;
force tfd_spectator_allowAIUnconscious = false;
...
force tfd_spectator_sidesUnconscious = 1;
force tfd_spectator_TPPCamera = false;
force tfd_spectator_TPPCameraUnconscious = false;
force tfd_spectator_unconsciousDelay = 30;

// TFD - Suppress
force tfd_suppress_checkLOS = true;
force tfd_suppress_overlayFadeoutTime = 10;
force tfd_suppress_overlayOpacity = 0.96;
force tfd_suppress_overlayTexture = 0;
force tfd_suppress_projectileMaxDistance = 9;
force tfd_suppress_shooterMinDistance = 0;

// TFD - tagging
force tfd_tagging_enabled = true;

// TFD - towing
force tfd_towing_addToCars = true;
force tfd_towing_addToHeavyDutyVehicles = true;

// TFD - Zeus
force tfd_Zeus_Module_AISpawnsEast = true;
force tfd_Zeus_Module_AISpawnsIndep = true;
force tfd_Zeus_Module_AISpawnsWest = true;
force tfd_Zeus_Module_CivilianSpawns = true;
force tfd_Zeus_Module_MedicalDummy = true;
tfd_Zeus_Module_SafeZone = true;
