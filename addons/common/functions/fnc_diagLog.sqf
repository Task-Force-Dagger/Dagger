 ...
 * \TFD_common\functions\diagnostics\fn_diagLog.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * [4, "Player: '%1', Time: '%2'", [player, time], "core"] call TFD_common_fnc_diagLog;
 * 
 */
...
if (missionNamespace getVariable ["TFD_debug_enabled", false]) then {
    [_level, _message, _params, _extension, _modification] call TFD_common_fnc_log;
};
