 ...
 * \TFD_common\functions\sounds\fn_loop3dSoundLocal.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player, "AlarmBell", [], -1, -1, 6] call TFD_common_fnc_loop3dSoundLocal;
 *
 */
...
if (_soundInUse) exitWith {
    [_object, _soundClass, _position, _distance, _maxDistance, _duration, _pitch, _isSpeech] spawn {
        ...
        sleep 0.1;
        [_object, _soundClass, _position, _distance, _maxDistance, _duration, _pitch, _isSpeech] call TFD_common_fnc_loop3dSoundLocal;
    };
};
