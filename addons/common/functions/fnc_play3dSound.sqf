 ...
 * \TFD_common\functions\sounds\fn_play3dSound.sqf
 * by Ojemineh
 * 
 ...
 *
 * Example:
 * [player, "AlarmBell", [], -1, -1, 6] call TFD_common_fnc_play3dSound;
 *
 */
...
[_object, _soundClass, _position, _distance, _maxDistance, _duration, _pitch, _isSpeech] remoteExecCall ["TFD_common_fnc_play3dSoundLocal", 0, false];
