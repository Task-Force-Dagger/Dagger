 ...
 * \TFD_common\functions\common\fn_createLitterServer.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * [player, "MedicalGarbage_01_FirstAidKit_F"] call TFD_common_fnc_createLitterServer;
 * 
 */
...
[_unit, _className, _offset] spawn {
    ...
    if ([_unit] call TFD_common_fnc_isInBuilding) then {
