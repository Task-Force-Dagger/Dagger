 ...
 * \TFD_common\functions\sounds\fn_play3dSoundLocal.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player, "AlarmBell", [], -1, -1, 6] call TFD_common_fnc_play3dSoundLocal;
 *
 */
...
if (_soundInUse) exitWith {
    [_object, _soundClass, _position, _distance, _maxDistance, _duration, _pitch, _isSpeech] spawn {
        ...
        [_object, _soundClass] call TFD_common_fnc_stop3dSoundLocal;
        sleep 0.1;
        [_object, _soundClass, _position, _distance, _maxDistance, _duration, _pitch, _isSpeech] call TFD_common_fnc_play3dSoundLocal;
    };
};

// -------------------------------------------------------------------------------------------------

private _soundObject = createSimpleObject [TFD_COMMON_HELPER_OBJECT, [0,0,0], true];
_soundObject hideObject true;
_soundObject attachTo [_object, _position];

_soundArray pushBackUnique [_soundClass, _soundObject];
_object setVariable ["TFD_sound3d", _soundArray];
...
private _handler = [_object, _soundObject, _soundClass, _distance, _maxDistance, _duration, _pitch, _isSpeech] spawn {
    ...
    [_soundObject, _soundClass, _distance, _maxDistance, _pitch, _isSpeech] call TFD_common_fnc_say3dLocal;
