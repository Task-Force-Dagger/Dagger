 ...
 * \TFD_common\functions\diagnostics\fn_logServer.sqf
 * by Ojemineh
 * 
 * add a rpt-log
 * 
 ...
 * 
 * Example:
 * [4, "Player: '%1', Time: '%2'", [player, time], "core"] call TFD_common_fnc_logServer;
 * 
 */
...
["TFD_common_log", [_level, _message, _params, _extension, _modification]] call CBA_fnc_serverEvent;
