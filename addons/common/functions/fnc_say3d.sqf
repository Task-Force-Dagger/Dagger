 ...
 * \TFD_common\functions\sounds\fn_say3d.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player, "AlarmBell"] call TFD_common_fnc_say3d;
 *
 */
...
[_object, _soundClass, _distance, _maxDistance, _pitch, _isSpeech] remoteExecCall ["TFD_common_fnc_say3dLocal", 0, false];
