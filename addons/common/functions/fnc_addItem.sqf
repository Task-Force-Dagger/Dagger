 ...
 * \TFD_common\functions\common\fn_addItem.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Examples:
 * [player, "ACE_EarPlugs", 1, [3,2,1], true] call TFD_common_fnc_addItem;
 * [truck1, "ACE_EarPlugs", 1] call TFD_common_fnc_addItem;
 * 
 */
