 ...
 * \TFD_common\functions\diagnostics\fn_diagLogGlobal.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * [4, "Player: '%1', Time: '%2'", [player, time], "core"] call TFD_common_fnc_diagLogGlobal;
 * 
 */
...
["TFD_common_diagLog", [_level, _message, _params, _extension, _modification]] call CBA_fnc_globalEvent;
