 ...
 * \TFD_common\functions\sounds\fn_speak3d.sqf
 * by Ojemineh
 *
 ...
 *
 * Example:
 * [player, "cp_mission_accomplished_1", -1, -1, 4.5] call TFD_common_fnc_speak3d;
 *
 */
...
[_unit, _soundClass, _distance, _maxDistance, _duration, _pitch, _isSpeech] remoteExecCall ["TFD_common_fnc_speak3dLocal", 0, false];
