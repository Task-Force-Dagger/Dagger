 ...
 * \TFD_common\functions\common\fn_createLitter.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * [player, "MedicalGarbage_01_FirstAidKit_F"] call TFD_common_fnc_createLitter;
 * 
 */
...
if (missionNamespace getVariable ["ace_medical_allowLitterCreation", false]) then {
    [_unit, _className, _offset] remoteExecCall ["TFD_common_fnc_createLitterServer", 2];
};
