...
class Extended_DisplayLoad_EventHandlers {
    class RscDisplayMultiplayerSetup {
        tfd_slotting = QUOTE(_this call (uiNamespace getVariable 'FUNC(initDisplayMultiplayerSetup)'));
    };
    class RscDisplayDebriefing {
        tfd_override_end_text = QUOTE(_this call (uiNamespace getVariable 'FUNC(initDisplayDebriefing)'));
    };
};
