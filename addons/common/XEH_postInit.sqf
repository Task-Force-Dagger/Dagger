...
/// Some code relies on tfd_common__VarSync being set before processing e.g. briefing/radio assignment
// Register event to recieve notification of variable synchorization has been completed.
[QGVAR(serverVariableSyncResponse),{
    GVAR(VarSync) = true;
    diag_log "TFD Common: Variable Synchronization Completed";
