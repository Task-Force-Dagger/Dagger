...
class respawnMenuDialog {
    idd = 26893;
    movingEnable = 0;
    onLoad="['onLoad'] spawn tfd_respawn_fnc_handleRespawnUI;";
...
class respawnMenuMapDialog {
    ...
    class controls { 
        class FullRespawnMap : RscMapControl
        {
            ...
            w = 1 * safezoneW;
            h = 1 * safezoneH;
            onDraw = "_this call tfd_respawn_fnc_respawnDrawMapIcons";
            onSetFocus = "['respawnMapLoaded'] spawn tfd_respawn_fnc_handleRespawnUI";
            onMouseButtonDown = "['respawnMap_onMouseButtonDown',_this] spawn tfd_respawn_fnc_handleRespawnUI";
            onKeyUp = "['respawnMap_keyUp',_this] spawn tfd_respawn_fnc_handleRespawnUI";
        };
    };
};