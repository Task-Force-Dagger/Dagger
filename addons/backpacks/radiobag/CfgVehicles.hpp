...
class CfgVehicles {
    ...
    class GVAR(RadioBag_01_BLACK): GVAR(RadioBag_01_Base) {
        ...
        scopeArsenal = 2;
        scopeCurator = 2;
        displayName = "$STR_TFD_Backpacks_RadioBag_02_BLACK";
        descriptionShort = "";
        editorPreview = "";
    ...
    class GVAR(RadioBag_01_GHEX): GVAR(RadioBag_01_Base) {
        ...
        scopeArsenal = 2;
        scopeCurator = 2;
        displayName = "$STR_TFD_Backpacks_RadioBag_02_HEX_GREEN";
        descriptionShort = "";
        editorPreview = "";
    ...
    class GVAR(RadioBag_01_HEX): GVAR(RadioBag_01_Base) {
        ...
        scopeArsenal = 2;
        scopeCurator = 2;
        displayName = "$STR_TFD_Backpacks_RadioBag_02_HEX_CAMO";
        descriptionShort = "";
        editorPreview = "";
        picture = "\a3\Supplies_F_Enoch\Bags\Data\UI\icon_B_RadioBag_01_hex_F_ca.paa";
        hiddenSelections[] = {"Camo1"};
    ...
    class GVAR(RadioBag_01_MTP): GVAR(RadioBag_01_Base) {
        ...
        scopeArsenal = 2;
        scopeCurator = 2;
        displayName = "$STR_TFD_Backpacks_RadioBag_02_MTP";
        descriptionShort = "";
        editorPreview = "";
    ...
    class GVAR(RadioBag_01_TROPIC): GVAR(RadioBag_01_Base) {
        ...
        scopeArsenal = 2;
        scopeCurator = 2;
        displayName = "$STR_TFD_Backpacks_RadioBag_trop";
        descriptionShort = "";
        editorPreview = "";
    ...
    class GVAR(RadioBag_01_OUCAMO): GVAR(RadioBag_01_Base) {
        ...
        scopeArsenal = 2;
        scopeCurator = 2;
        displayName = "$STR_TFD_Backpacks_RadioBag_ou";
        descriptionShort = "";
        editorPreview = "";
    ...
    class GVAR(RadioBag_01_WDL): GVAR(RadioBag_01_Base) {
        ...
        scopeArsenal = 2;
        scopeCurator = 2;
        displayName = "$STR_TFD_Backpacks_RadioBag_02_WDL";
        descriptionShort = "";
        editorPreview = "";
