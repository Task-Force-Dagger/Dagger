class TFD_ModuleCivilianSpawns: Module_F {
    scope = 2;
    displayName = "AI Spawn - Civilian";
    icon = "\z\tfd\addons\media\images\Icons\AI CIV.paa";
    category = QUOTE(PREFIX);
    function = "tfd_fnc_moduleCivilianSpawns";
    functionPriority = 2;
    isGlobal = 0;
    ...
    class Attributes: AttributesBase {
        ...
        class GarrisonedUnitsMin: Edit {
            property = "tfd_AI_GarrisonedUnitsMin";
        ...
        class GarrisonedUnitsMax: Edit {
            property = "tfd_AI_GarrisonedUnitsMax";
        ...
        class CivPedPatrolsMin: Edit {
            property = "tfd_AI_CivPedPatrolsMin";
        ...
        class CivPedPatrolsMax: Edit {
            property = "tfd_AI_CivPedPatrolsMax";
        ...
        class CivVehPatrolsMin: Edit {
            property = "tfd_AI_CivVehPatrolsMin";
        ...
        class CivVehPatrolsMax: Edit {
            property = "tfd_AI_CivVehPatrolsMax";
        ...
        class CivVehParkedMin: Edit {
            property = "tfd_AI_CivVehParkedMin";
        ...
        class CivVehParkedMax: Edit {
            property = "tfd_AI_CivVehPaarkedMax";
