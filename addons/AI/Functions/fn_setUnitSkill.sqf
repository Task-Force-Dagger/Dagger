...
if !(isNil "tfd_AI_AimingAccuracy") then {
    _skillv = [
        (TFD_AI_AimingAccuracy + random 0.20),
        (TFD_AI_AimingShake + random 0.20),
        (TFD_AI_AimingSpeed + random 0.20),
        (TFD_AI_Commanding),
        (TFD_AI_Courage), 1,
        (TFD_AI_General),
        (TFD_AI_ReloadSpeed + random 0.50),
        (TFD_AI_SpotDistance + random 0.30),
        (TFD_AI_SpotTime + random 0.40)
    ];
};
