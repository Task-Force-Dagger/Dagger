class TFD_ModuleAISpawnsIndependent: Module_F {
    scope = 2;
    displayName = "AI Spawn - Independent";
    icon = "\z\tfd\addons\media\images\icons\AI INDEP.paa";
    category = QUOTE(PREFIX);
    function = "tfd_fnc_moduleAISpawns";
    functionPriority = 2;
    isGlobal = 0;
    ...
    class Attributes: AttributesBase {
        ...
        class GarrisonedGroupsMin: Edit {
            property = "tfd_AI_GarrisonedGroupsMin";
        ...
        class GarrisonedGroupsMax: Edit {
            property = "tfd_AI_GarrisonedGroupsMax";
