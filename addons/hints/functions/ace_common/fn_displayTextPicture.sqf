 ...
 * \z\tfd\addons\hints\functions\ace_common\fn_displayTextPicture.sqf
 * by Ojemineh
 * 
...
private _hint_option_ace = (missionNamespace getVariable ["tfd_hint_option_ace", true]);
...
if (_hint_enabled && _hint_option_ace) then {
 ...
 _text = format [hint_tfd_image_3, _image, _imageColor call BIS_fnc_colorRGBtoHTML, _text];
 
 [_text] call tfd_fnc_hint;
