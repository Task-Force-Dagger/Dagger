 ...
 * \z\tfd\addons\hints\functions\fn_hint.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * [ format [hint_tfd_default, "Hello World"] ] call tfd_fnc_hint;
 * 
 */
...
[_text, _color, _sound, _delay, _position] spawn {
    ...
    private _hint_enabled  = (missionNamespace getVariable ["tfd_hint_enabled", true]);
    private _hint_position  = (missionNamespace getVariable ["tfd_hint_position", 0]);
    private _hint_duration  = (missionNamespace getVariable ["tfd_hint_duration", 15]);
    private _hint_sound   = (missionNamespace getVariable ["tfd_hint_sound", 1]);
    private _hint_color_bg  = (missionNamespace getVariable ["tfd_hint_color_background", [0.000,0.000,0.000,0.5]]);
    private _hint_color_0  = (missionNamespace getVariable ["tfd_hint_color_default", [0.000,0.824,0.000,1]]);
    private _hint_color_1  = (missionNamespace getVariable ["tfd_hint_color_info", [0.824,0.824,0.000,1]]);
    private _hint_color_2  = (missionNamespace getVariable ["tfd_hint_color_alert", [0.824,0.000,0.000,1]]);
    private _hint_queue_size = (missionNamespace getVariable ["tfd_hint_queue_size", 3]);
    private _hint_queue_alpha = (missionNamespace getVariable ["tfd_hint_queue_alpha", 0.4]);
    ...
    _display = uiNamespace getVariable "tfd_ctrlHint";
    ...
    switch (_position) do {
        case 1: {
            ...
            _scrollDown = true;
            _barLeft = true;
            _queue = uiNamespace getVariable ["tfd_hint_queue_1", []];
        };
        case 2: {
            _width = 0.15 * safezoneW;
            _height = 0.15 * safezoneH;
            ...
            _scrollDown = false;
            _barLeft = true;
            _queue = uiNamespace getVariable ["tfd_hint_queue_2", []];
        };
        case 3: {
            _width = 0.15 * safezoneW;
            _height = 0.15 * safezoneH;
            ...
            _scrollDown = false;
            _barLeft = false;
            _queue = uiNamespace getVariable ["tfd_hint_queue_3", []];
        };
        default {
            _width = 0.15 * safezoneW;
            _height = 0.15 * safezoneH;
            ...
            _scrollDown = true;
            _barLeft = false;
            _queue = uiNamespace getVariable ["tfd_hint_queue_0", []];
        };
    };
    ...
    switch (_sound) do {
        ...
        case 4: { playSound ["tfdticalPing4", true]; };
        default {};
    };
    ...
    switch (_position) do {
        case 0: { uiNamespace setVariable ["tfd_hint_queue_0", _queue]; };
        case 1: { uiNamespace setVariable ["tfd_hint_queue_1", _queue]; };
        case 2: { uiNamespace setVariable ["tfd_hint_queue_2", _queue]; };
        case 3: { uiNamespace setVariable ["tfd_hint_queue_3", _queue]; };
    };
