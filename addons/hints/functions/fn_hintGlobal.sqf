 ...
 * \z\tfd\addons\hints\functions\fn_hintGlobal.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * [ format [hint_tfd_default, "Hello World"] ] call tfd_fnc_hintGlobal;
 * 
 */
...
[_text, _color, _sound, _delay, _position] remoteExecCall ["tfd_fnc_hint", 0];
