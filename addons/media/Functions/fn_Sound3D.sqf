...
Examples:
 (begin example)
  [Speaker, "AirRaid", 500] call TFD_fnc_Sound3D;
  [Jason, "JohnCena", 250] call TFD_fnc_Sound3D;
  [this, "NukeAlarm", 250] call TFD_fnc_Sound3D;
 (end)
...
if (!isServer) exitWith {
 _this remoteExec ["TFD_fnc_Sound3D", 2];
};
