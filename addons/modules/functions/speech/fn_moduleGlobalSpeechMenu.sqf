 ...
 * \z\tfd\addons\modules\functions\speech\fn_moduleGlobalSpeechMenu.sqf
 * by Ojemineh
 * 
 * module function
 * 
 ...
 * 
 * Example:
 * [] call TFD_fnc_moduleGlobalSpeechMenu;
 * 
 */
...
private _holdText = format [localize "STR_TFD_Module_GlobalSpeech_HoldAction", _unitName];
private _holdIcon = "\z\tfd\addons\modules\data\gui\holdAction_speech_ca.paa";
