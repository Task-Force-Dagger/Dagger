    ...
    class Object {
        class AttributeCategories {
            class PREFIX {
                collapsed = 1;
                class Attributes {
                    class TFD_Arsenal_Select {
                        property = QUOTE(TFD_Arsenal_Select);
                        ...
                        expression = "if (_value > -1) then {[_this, _value] call TFD_fnc_FullArsenal;}";
                        typeName = "STRING";
                        condition = "objectHasInventoryCargo - objectVehicle";
                        defaultValue = "-1";
                    };
                        class TFD_Ammo_Select {
                        property = QUOTE(TFD_Ammo_Select);
                        control = "ArsenalSelect";
                        ...
                        expression = "if (_value > -1) then {[_this, _value] call TFD_fnc_LimitedArsenal;}";
                        typeName = "STRING";
                        condition = "objectHasInventoryCargo - objectVehicle";
                        defaultValue = "-1";
                    };
                    //     class TFD_LimitedAmmoSelect {
                    //     property = QUOTE(TFD_LimitedAmmoSelect);
                    ...
                    //     defaultValue = "-1";
                    // };
                        class TFD_Equipment_Select {
                        property = QUOTE(TFD_Equipment_Select);
