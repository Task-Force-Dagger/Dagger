/*
Function name:TFD_fnc_TFD_fnc_AmmoCrate;
Author: Mr H.
...
Example(s):
[this,10,true,true] call TFD_fnc_AmmoCrate;
*/
...
_box setVariable ["TFD_AmmoMagazines", _allMagazinesType];

_handlerIndex = _box addEventHandler
 ["ContainerOpened",
  {
  _box = _this select 0;
  _allMagazinesType = _box getVariable "TFD_AmmoMagazines";



  clearMagazineCargoGlobal _box;
  {_box addMagazineCargoGlobal [_x,10];} forEach _allMagazinesType;
        _box addItemCargoGlobal ["TFD_medbags_FirstAid",1];
        _box addItemCargoGlobal ["TFD_medbags_MedicKit",1];
        _box addItemCargoGlobal ["TFD_mopp",1];
  _box addItemCargoGlobal ["HandGrenade",8];
  _box addItemCargoGlobal ["SmokeShell",8];
  _box addItemCargoGlobal ["ACE_M84",8];
  }
 ];
_box setVariable ["TFD_AmmoCrateEHIndex", _handlerIndex, true];
...
_box setVariable ["TFD_AmmoCrateParameters", _params, true];
...
_statement =
 ...
 _box = _this select 0;
 _params = _box getVariable "TFD_AmmoCrateParameters";
 [[_params],
  {
  params ["_params"];
  _box = _params select 0;
  _handlerIndex = _box getVariable "TFD_AmmoCrateEHIndex";
  ...
  _params call TFD_fnc_AmmoCrate;
  }
