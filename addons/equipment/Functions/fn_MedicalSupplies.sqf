/*
Function: TFD_fnc_MedicalSupplies
...
Examples:
 (begin example)
  [this] call TFD_fnc_MedicalSupplies;
  [this, "MERT", true] call TFD_fnc_MedicalSupplies;
 (end)
...
private _VarType = _container getVariable ["TFD_Equipment_Select", -1];
