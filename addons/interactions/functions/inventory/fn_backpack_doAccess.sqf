 ...
 * \z\tfd\addons\interactions\functions\inventory\fn_backpack_doAccess.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * [player, unit1] call TFD_interactions_fnc_backpack_doAccess;
 * 
 */
...
[_player, _target] spawn {
    ...
    if (isPlayer _target) then {
        [_player, _target] remoteExecCall ["tfd_interactions_fnc_backpack_access", _target];
    };
