 ...
 * \z\tfd\addons\interactions\functions\tapshoulder\fn_tapshoulder_canTap.sqf
 * by Ojemineh
 * 
 ...
 * 
 * Example:
 * [player, unit1] call TFD_interactions_fnc_tapshoulder_canTap;
 * 
 */
...
private _enableAI = (missionNamespace getVariable ["tfd_interactions_tapshoulder_ai", true]);
