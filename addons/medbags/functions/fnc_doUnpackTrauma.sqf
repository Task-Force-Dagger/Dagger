...
[_unit] spawn {
 ...
 {true},
    ...
    if (TFD_MEDICAL_SUPPLIES_UNPACK_SUCCESS) exitWith {
        ...
        _unit removeItem "TFD_medbags_Trauma";
        
        private _order = [3,0,2];
        ...
        [_unit, "kat_accuvac", 01, _order, _overflow] call tfd_common_fnc_addItem;
        [_unit, "kat_X_AED", 01, _order, _overflow] call tfd_common_fnc_addItem;
        [_unit, "kat_stethoscope", 01, _order, _overflow] call tfd_common_fnc_addItem;
        [_unit, "kat_Pulseoximeter", 01, _order, _overflow] call tfd_common_fnc_addItem;
        ...
        [_unit, "kat_TXA", 06, _order, _overflow] call tfd_common_fnc_addItem;
