/*
Function: tfd_fnc_ConfigZeus

Description:
    Used to configure a Zeus Module. Ensures that any AI placed down by that Zeus have Dynamic Sim
    enabled and their difficulty settings configured to the TFD Default.
    ...
    "CuratorObjectPlaced", {
        ...
        _result  = call {
            if (_class isKindOf "Man") exitWith {
                ...
                [_Group, "TFD Default"] remoteExec ["tfd_fnc_SetUnitSkill",2];
