/*
Function: TFD_fnc_setRepairFacility
...
_object setTriggerStatements [
    ...
    "call { _v = (thisList select 0); if (_v isKindOf ""UAV"") exitWith { [_v] execVM ""z\tfd\addons\Vehicles\Scripts\uav.sqf""; }; _type = { if (_v isKindOf _x) exitWith { _x } ; nil } count [""UAV"", ""Plane"", ""Helicopter"", ""LandVehicle""];if (_type isEqualTo 0) exitWith {};[_type, _v, 30, 30] execVM ""z\tfd\addons\Vehicles\Scripts\general.sqf"";};",
    ""
];