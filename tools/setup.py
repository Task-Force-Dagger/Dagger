...
def main():
    ...
    print("""
  ######################################
  # tfd Development Environment Setup #
  ######################################

  This script will create your tfd dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your tfd project folder:
    [Arma 3 installation directory]\\{} => tfd project folder
    P:\\{}                              => tfd project folder
