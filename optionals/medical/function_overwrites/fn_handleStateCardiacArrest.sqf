...
if (_timeDiff >= 1) then {
    ...
    private _totalTimeLeft = _unit getVariable ["TFD_REVIVAL", TFD_medical_persistantReviveTimer];
    if(TFD_medical_persistantRevive) then {
    ...
    _unit setVariable ["TFD_REVIVAL", _totalTimeLeft, true];
};